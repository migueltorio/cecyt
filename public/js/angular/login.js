...
angular.module('login').controller('LoginCtrl', function($scope, $http) {
  $scope.mostrarRegistrar = mostrarRegistrar;
  $scope.mostrarRecuperar = mostrarRecuperar;

  setView('iniciarSesion');
  ...
  $scope.paises = [{ codigo: 'PY', descripcion: 'Paraguay'},
                   { codigo: 'AR', descripcion: 'Argentina'},
                   { codigo: 'BR', descripcion: 'Brasil'},
                   { codigo: 'IT', descripcion: 'Italia'}];
               
  $scope.documentos = [{ codigo: 'CI', descripcion: 'Cédula'},
